...
1. Embedding with publishers during the production cycle of new works;
2. Providing feedback to platform developers to inform/adjust features/functionality that improve preservability;
3. Testing, refining, and expanding the phase one Guidelines for [Preserving New Forms of Scholarship](/)
