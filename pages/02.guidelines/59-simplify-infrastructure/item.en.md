---
title: '59. For a custom web application built for a single publication, or where custom software is part of the project, keep the infrastructure and installation process simple, select widely used technologies.'
taxonomy:
    tag:
        - planning
...
_2. [General considerations for designing or selecting publication platforms](/guidelines/2-assess-technology)_  
_3. [Favor existing standards](/guidelines/3-use-existing-standards)_
