...
_18. [For linear publications, export packages should include core intellectual components of the work separated from the publishing platform and transformed to an existing full-text standard](/guidelines/18-export-to-full-text-standard)_  
