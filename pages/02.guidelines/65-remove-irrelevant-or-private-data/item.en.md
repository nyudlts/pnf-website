---
title: '65. Ensure private or irrelevant data is removed from data exports.'
taxonomy:
    tag:
        - 'export packages'
        - 'software and data'
...
* _[18 - For linear publications, export packages should include core intellectual components of the work separated from the publishing platform and transformed to an existing full-text standard](/guidelines/18-export-to-full-text-standard)_  
