---
title: '47. Plan the structure of URLs so that they are more likely to persist over time; redirect when needed.'
taxonomy:
    tag:
        - planning
...
_27. [Persistent identifiers can be used at the publication resource level](/guidelines/27-assign-persistent-identifiers)_   
_31. [Persistent identifiers should assigned to new versions of the work](/guidelines/31-persistent-identifiers-for-versions)_