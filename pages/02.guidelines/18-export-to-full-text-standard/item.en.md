---
title: '18. For linear publications, export packages should include core intellectual components of the work separated from the publishing platform and transformed to an existing full-text standard.'
taxonomy:
    tag:
...
_3. [Use existing standards for export formats](/guidelines/3-use-existing-standards)_  
_10. [Identify and document the core intellectual components of a work](/guidelines/10-define-core-intellectual-components)_  
_20. [Ensure exports cover all core intellectual components](/guidelines/20-export-includes-core-components)_