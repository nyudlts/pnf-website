---
title: '13. When embedding audio or video, acquire the highest quality version of the media files to use as a preservation copy.'
taxonomy:
    tag:
        - 'embedded resources'
---
...
_11. [Use non-proprietary, broadly supported and adopted open file formats](/guidelines/11-use-non-proprietary-formats)_  
_65. [Remove private data from export packages](/guidelines/65-remove-irrelevant-or-private-data)_