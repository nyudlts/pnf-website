---
title: '27. Assign unique persistent identifiers to each publication resource that may be referenced as an independent artifact. Use these to reference the resource within the publication and metadata.'
taxonomy:
    tag:
