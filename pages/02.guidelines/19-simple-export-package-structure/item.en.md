---
title: '19. Publication export packages created for preservation should have a simple package structure with consolidated structured metadata and a predictable file and folder structure.'
taxonomy:
    tag:
...
_See also:_  
_22. [Use an appropriate metadata serialization within the export package](/guidelines/22-metadata-in-structured-format)_
