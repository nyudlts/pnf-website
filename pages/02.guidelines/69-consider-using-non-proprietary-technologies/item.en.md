---
title: '69. When selecting a tool or player to embed enhanced features, consider using non-proprietary, open, and/or widely used technologies and standards. '
tags:
    - 'embedded resources'
taxonomy:
    tag:
...
* _[51 - When embedding video and other media in web-based publications, host the media files local to the website using standard HTML](/guidelines/51-local-media-files) _
