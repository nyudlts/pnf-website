...
* **[Keywords](#keywords)**
* **[Self-Assessment Tool](#tool)**
* **[Citing or linking to this work](#citing-linking)**
...
To study this challenge, a group of digital preservation institutions, libraries, and university presses worked together on two Andrew W. Mellon Foundation funded projects, Enhancing Services to Preserve New Forms of Scholarship and Embedding Preservability for New Forms of Scholarship, both led by New York University Libraries. 

In Enhancing Services to Preserve New Forms of Scholarship, a group of publishers, platform developers, and preservation service providers examined a variety of enhanced ebooks and identified which features can be preserved at scale using tools currently available. Publishing organizations included NYU Press, Michigan Publishing, the University of Minnesota Press, UBC Press and Stanford University Press. Preservation service organizations included CLOCKSS, Portico and the libraries of the University of Michigan and NYU. Their findings, combined with the knowledge and research of experts in preservation, publishing, and copyright, resulted in the previous edition of these guidelines. A full report on the Enhancing Services project can be found at [https://doi.org/10.33682/0dvh-dvr2](https://doi.org/10.33682/0dvh-dvr2?target=_blank).

In Embedding Preservability, a team of preservation experts, a publishing specialist, and a project manager “embedded” with publishers during publication processes for complex digital books and journal issues. The team encountered various publishing workflows and used the guidelines to provide advice about improving the preservability of projects as they were being envisioned and produced. Through this process, and with further meetings with platform developers, the team identified gaps in the guidelines. Those gaps led to this updated version, which includes four new guidelines (69–72), examples, and numerous improvements to the existing set of recommendations. 
...
### Terminology
_Publication resources:_ The digital materials that make up the publication. “Resource” does not necessarily refer to a specific file but to the content and form. Some resources may consist of multiple files or be expressed in different formats. The publication itself is a resource. If separate from the body of the publication, each of the supporting items are also resources -  each figure graphic, video clip, piece of software, dataset, 3D visualization etc. The publisher can work with a preservation service to determine which publication resources are required to represent its core intellectual components, and which files are appropriate to represent each resource.

_Core intellectual components:_ The aspects of a publication that are considered integral to the understanding of it. Rather than pertaining to specific digital resources or renditions of a publication, this is a more abstract sense of the facets of the work. For example: the linear text divided by section headings, the media placed at specific locations within the text, the additional digital resources supplied by the author with descriptive information tied to them. This kind of abstraction is helpful in preservation for communicating requirements and then designing a strategy that covers the important aspects of a work. 
<a name="keywords"></a>

### Keywords 
The following keywords were applied to the guidelines to aid with navigation. 
* _[embedded resources](/guidelines/tag:embedded%20resources):_ Non-text resources such as images, audio, video, visualizations, etc. that appear in a publication. 
* _[export packages](/guidelines/tag:export%20packages):_ A package of content created to represent a publication for the purpose of transferring it to a preservation service.
* _[EPUB](/guidelines/tag:EPUB):_ An electronic publication file format and technical standard published by the International Digital Publishing Forum.
* _[planning](/guidelines/tag:planning):_ Bringing a preservation mindset into pre-production and design phases.
* _[publishing platforms](/guidelines/tag:publishing%20platforms):_ Software used to manage and provide access to one or more publications.
* _[rights](/guidelines/tag:rights):_ Issues pertaining to copyright, terms of use/service, or licensing of publication resources.
* _[software and data](/guidelines/tag:software%20and%20data):_ In general these refer to raw and executable materials offered in support of the key points of the text.
* _[third party dependencies](/guidelines/tag:third-party%20dependencies):_ A component of a publication that is dependent on a service or platform that is outside of the control of the publisher.
* _[web based publications](/guidelines/tag:web-based%20publications):_ Publications designed primarily to be presented in the form of a website rather than downloaded as a document (as with EPUB or PDF).
<a name="tool"></a>

### Self-Assessment Tool
The Embedding Preservability project made it clear that, even with access to these guidelines, publishers, platform developers, and content creators often benefit from further assistance to make their work preservable. During the project, the embedding team met with publishers throughout the course of publication processes and provided customized support in identifying particular guidelines and solutions. In order to facilitate this more tailored experience, the team created a [self-assessment tool](https://doi.org/10.33682/r23i-9zg2?target=_blank), which publishers and content creators can use to assess preservability needs, identify guidelines from this document, and begin to find solutions.    
<a name="citing-linking"></a>
